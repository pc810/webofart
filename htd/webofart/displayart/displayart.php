                                ...
                                if ($total_r > 0) {
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        if ($lte < 3) {
                                            ...
                                            $delete = "/webofart/art/deleteart.php?artid=" . $art_id;
                                            $update = "/webofart/art/updateartregistration.php?artid=" . $art_id;
                                            $carts = "/webofart/displayart/addtocart.php?artid=" . $art_id;
                                            if (isset($_SESSION["admin"]) && isset($_SESSION["username"]) && $_SESSION["admin"] == 1) {
                                                echo '
                                                            <div class="card">
                                                            <div class="row">
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <a href="' . $delete . '">
                                                                    <img src="/webofart/image/web/delete.png" width="20px">
                                                                    </a>
                                                             <a href="' . $update . '" class="ml-auto btn btn-dark">
                                                                    <small>Edit</small>
                                                                    </a>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                            </div>
